...
sidebar:
  order: 6
  label: 6. Getting Started With TypeScript
---
...
The "exclude" property indicates to the compiler a list of files that should not be included in the compilation. This can include files such as "node\_modules" or test files.
